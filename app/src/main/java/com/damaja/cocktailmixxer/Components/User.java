...
public class User extends RowItem implements Serializable {
	...
	@Override
	public int hashCode() {  // Generierung eines Hashcodes, notwendig f�r Serialisierung und damit der Aktive User richtig bei App neustart angezeigt wird
		final int prime = 31;
	...
	public String toString() {	
		return "Benutzername: " + B_Name + " Alter: " + Alter + " Gr��e: "
